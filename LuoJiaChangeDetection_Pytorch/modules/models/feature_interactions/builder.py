...
from .deepsuper_featureinteraction import DeepSuperInteraction
...
class FeatureInteractionBuilder(BaseModuleBuilder):
    REGISTERED_MODULES = {
        ...
        'CrossAttentionInteraction': CrossAttentionInteraction, 'DeepSuperInteraction':DeepSuperInteraction,
        'MixingMaskAttentionInteraction': MixingMaskAttentionInteraction,
    }
    '''build'''
