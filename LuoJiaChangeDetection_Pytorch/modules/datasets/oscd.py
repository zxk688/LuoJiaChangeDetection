...
class OSCDDataset(BaseChangeDetectionDataset):
    num_classes = 2
    ...
    def __init__(self, mode, logger_handle, dataset_cfg):
        super(OSCDDataset, self).__init__(mode=mode , logger_handle=logger_handle, dataset_cfg=dataset_cfg)
        self.mode = mode
    ...
    def __getitem__(self, index):
        ...
        sample_meta = {'ms1': ms_img1, 'ms2': ms_img2, 
