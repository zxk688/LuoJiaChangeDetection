...
class TextSplittedDataset(BaseChangeDetectionDataset):
    num_classes = 2
    ...
    def __init__(self, mode, logger_handle, dataset_cfg):
        super(TextSplittedDataset, self).__init__(mode=mode, logger_handle=logger_handle, dataset_cfg=dataset_cfg)
        self.mode = mode
