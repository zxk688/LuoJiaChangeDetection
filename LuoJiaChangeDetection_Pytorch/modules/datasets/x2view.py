...
class X2ViewDataset(BaseChangeDetectionDataset):
    def __init__(self, mode, logger_handle, dataset_cfg):
        super(X2ViewDataset, self).__init__(mode=mode, logger_handle=logger_handle, dataset_cfg=dataset_cfg)
        self.mode = mode
