...
class HTCDDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_sat = torch.from_numpy(img_sat.transpose((2, 0, 1)).astype(np.float32))
        ...
        img_uav = torch.from_numpy(img_uav.transpose((2, 0, 1)).astype(np.float32))
        ...
        sample_meta = {'image1': img_sat, 'image2': img_uav, 'gt': gt, 'fname': filename}
