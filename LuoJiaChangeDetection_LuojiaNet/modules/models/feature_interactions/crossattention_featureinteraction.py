...
class MultiHeadDense(nn.Module):
    def __init__(self, d, bias=False):
        ...
        self.weight = Parameter(Tensor((d,d),dtype=luojianet.float32))
    ...
    #     luojianet.common.initializer(self.weight, a=math.sqrt(5))
...
class PositionalEncoding2D(nn.Module):
    ...
    def forward(self, tensor):
        ...
        pos_x = F.arange(x,dtype=luojianet.float32)
        pos_y = F.arange(y,dtype=luojianet.float32)
        ...
        emb = F.zeros((x, y, self.channels * 2),dtype=luojianet.float32)
