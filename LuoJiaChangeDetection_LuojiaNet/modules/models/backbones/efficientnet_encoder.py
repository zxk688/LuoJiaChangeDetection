...
import numpy as np
from luojianet import ops as ops
from luojianet import Tensor, nn
from luojianet.common import initializer as weight_init
from luojianet.common.initializer import Normal, Uniform
...
class MBConv(nn.Module):
    ...
    def __init__(
        ...
        se_layer: Callable[..., nn.Module] = SqueezeExcite,
    ) -> None:
        super().__init__()
...
class EfficientNetEncoder(nn.Module):
    def __init__(
        ...
        super().__init__()
        # Assuming efficientnet_b4 is defined in your code
        self._backbone = efficientnet_b4(pretrained=pretrained)
    ...
    def forward(self, x):
        ...
        for num, layer in enumerate(self._backbone.features):
            ref, test =  layer(ref),layer(test)  # encoding
            features1.append(ref)
            features2.append(test)

        return (features1[0],features1[3],features1[4],features1[5],features1[6],),(features2[0],features2[3],features2[4],features2[5],features2[6],)
