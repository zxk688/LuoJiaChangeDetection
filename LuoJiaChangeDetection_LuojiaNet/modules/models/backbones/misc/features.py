...
def _cell_list(net: nn.Module, flatten_sequential: bool = False) -> Iterable[Tuple[str, str, nn.Module]]:
...
class FeatureExtractWrapper(nn.Module):
    ...
    def __init__(self, net: nn.Module, out_indices: List[int] = [0, 1, 2, 3, 4]) -> None:
    ...
    def _get_feature_info(self, net: nn.Module) -> Dict[str, Any]:
        try:
    ...
    def _create_net(
        self, cells: Iterable[Tuple[str, str, nn.Module]], return_layers: Dict[str, int]
