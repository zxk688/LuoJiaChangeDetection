...
class NeighborFeatureAggregation(nn.Cell):
...
class TemporalFeatureFusionModule(nn.Cell):
...
class TemporalFusionModule(nn.Cell):
    ...
    def construct(self, x1_2, x1_3, x1_4, x1_5, x2_2, x2_3, x2_4, x2_5):
        # temporal fusion
...
class SupervisedAttentionModule(nn.Cell):
...
class Decoder(nn.Cell):
    ...
    def construct(self, d2, d3, d4, d5):
        # high-level
