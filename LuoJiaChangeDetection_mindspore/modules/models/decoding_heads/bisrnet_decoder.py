...
class BiSRNetDecoder(nn.Cell):
    def __init__(self,num_classes=7):
        ...
        self.classifierCD = nn.SequentialCell(nn.Conv2d(128, 64, kernel_size=1), nn.BatchNorm2d(64), nn.ReLU(), nn.Conv2d(64, 1, kernel_size=1))
    ...
    def construct(self,inputs,fi_out): 
        x1,x2 = inputs
        x_size = x1[0].shape
